...
class Toolbox:
    ...
    def vocode(self):
        ...
        if self.ui.current_vocoder_fpath is not None:
            self.ui.log("")
            wav, sampling_rate = vocoder.infer_waveform(spec, progress_callback=vocoder_progress)
        else:
    ...
    def init_vocoder(self):
        ...
        if model_fpath.name is not None and model_fpath.name.find("hifigan") > -1:
            ...
            model_config_fpaths = list(model_fpath.parent.glob("*.json"))
